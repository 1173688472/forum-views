<template>
  <div class="sss">
    <div class="login-box">
      <h2>欢迎登录</h2>
      <form  v-if="temporary.showRegisterUser">
        <div class="user-box">
        ...
        <a @click=" temporary.showRegisterUser = false" >注册 </a>
      </div>
      </form>
      <Register v-else @backLogin="backLogin"></Register>
    </div>
    <div class="item">
    <div class="total">
...
const backLogin = () => {
  temporary.showRegisterUser = true
}
const rainBg = ()=>{
  // 中间背景雨
    ...
    .total {
      ...
      .sphere {
        ...
        .sphere-bg {
          ...
          width: 120%;
          height: 150%;
          background: url('/src/assets/img/jijia.png') no-repeat center;
      ...
      .cicle3 {
        width: 70rem;
        height: 20rem;
        background: url('/src/assets/img/circle.png') no-repeat center;
        background-size: 100%;
        position: absolute;
        top: 35%;
        left: 50%;
      ...
      .cicle4 {
        ...
        left: 50%;
        transform-style: preserve-3d;
        background: url('/src/assets/img/53gqright.png') no-repeat center;
        background-size: 100%;
        transform: translateX(-50%) rotateX(75deg);
      ...
      .cicle5 {
        ...
        left: 50%;
        transform-style: preserve-3d;
        background: url('/src/assets/img/53gqleft.png') no-repeat center;
        background-size: 100%;
        transform: translateX(-50%) rotateX(75deg);
      ...
      .cicle6 {
        ...
        left: 50%;
        transform-style: preserve-3d;
        background: url('/src/assets/img/535gqbottomright.png') no-repeat center;
        background-size: 100%;
        transform: translateX(-50%) rotateX(75deg);
        animation: rotate3 3s linear infinite;
      }
      ...
      .cicle7 {
        ...
        left: 50%;
        transform-style: preserve-3d;
        background: url('/src/assets/img/53gqbottomleft.png') no-repeat center;
        background-size: 100%;
        transform: translateX(-50%) rotateX(75deg);
        animation: rotate4 3s linear infinite;
      }

      .cicle8, .cicle9, .cicle10, .cicle11 {
        width: 6rem;
        height: 6rem;
        position: absolute;
        top: 30%;
      ...
      .cicle8 {
        background: url('/src/assets/img/circle1.png') no-repeat;
        background-size: 100%;
      ...
      .cicle9 {
        background: url('/src/assets/img/circle2.png') no-repeat;
        background-size: 100%;
...
.login-box  .btn-handle{
  width: 100%;
  display: grid;
  grid-template-columns: repeat(2,50%);
  //justify-content: space-around;
}
.login-box  .btn-handle a {
  position: relative;
